...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (locale.charAt(0) == 'р' && locale.charAt(1) == 'у')
        {
            ...
            SortArray = new String[] { "Что это и для чего нужно?", "Базовые сортировки", "Сортировка Шелла", "Сортировка слиянием", "Пирамидальная сортировка", "Быстрая сортировка" };
        ...
        else
        {
            ...
            SortArray = new String[] { "What is it and what is it for?", "Basic sorting algorithms", "Shell sort", "Merge sort", "Heap sort", "Quick sort" };
        ...
        expandableListView.setOnChildClickListener(new OnChildClickListener() {
                public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                    ...
                    {
                        if (childPosition == 0) {
                            Intent intent = new Intent(SecondActivity.this, AboutSortActivity.class);
                            startActivity(intent);
                        }
                        else if (childPosition == 1) {
                            Intent intent = new Intent(SecondActivity.this, BasicSortAlgoActivity.class);
                            startActivity(intent);
                        }
                        else if (childPosition == 2) {
                            Intent intent = new Intent(SecondActivity.this, ShellSortActivity.class);
                            startActivity(intent);
                        }
                        else if (childPosition == 3) {
                            Intent intent = new Intent(SecondActivity.this, MergeSortActivity.class);
                            startActivity(intent);
                        }
                        else if (childPosition == 4) {
                            Intent intent = new Intent(SecondActivity.this, HeapSortActivity.class);
                            startActivity(intent);
                        }
                    }
                    return false;
