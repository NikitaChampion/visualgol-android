...
import com.gmail.nkigumnov.visualgol.algorithms.sorting.Counting;
...
public class CountingSort extends AppCompatActivity implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    private final TextView[] number = new TextView[7];
    private final TextView[] amount = new TextView[7];
    private Counting countingSort;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        generate();
        countingSort = new Counting(this, array, curSpeed);
    }
    ...
    private void generate() {
        for (int i = 0; i < array.length; ++i) {
            array[i] = Math.abs(random.nextInt()) % 7;
        }
        update();
    }
